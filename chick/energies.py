...
from torch.distributions import Laplace, MultivariateNormal, Normal
...
def multi_view(x_sample, x_2d, camera, **kwargs) -> Energy:
    """
    Energy function for conditioning on a monocular 2D pose.
    :param x_sample: The 3D pose sample generated by the model.
    :param x_2d: The 2D pose.
    ...
    x_2d_projected = []
    for cam in camera:
        x_2d_projected.append(cam.proj2D(x_sample))
