...
def add_model_options(parser):
    ...
    group.add_argument(
        "--arch",
        default="trans_enc",
        choices=["trans_enc", "trans_unet", "trans_dec", "gru"],
        type=str,
    ...
    group.add_argument("--layers", default=2, type=int, help="Number of layers.")
    group.add_argument(
        "--latent_dim", default=1024, type=int, help="Transformer/GRU width."
    )
    group.add_argument(
        "--cond_mask_prob",
        default=0.1,
